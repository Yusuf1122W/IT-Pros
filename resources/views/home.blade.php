    ...
    <html lang="nl">
        ...
        <body>
            ...
            <main>
                ...
                <p>the different teams. When your team wins youget a point, the team with the most points wins and stands number one on the</p>
                <p>leaderboard. The refferee will add the scores of the latest match and tournament to the app for all to see</p>
            </main>
            <footer>
